...
'Append line 'BridgeTripleBrace, Macros, PSN_BridgeTripleBrace,,' in follow file:
...
<Bentley.MicroStation.AddIn(MdlTaskID:="BridgeTripleBrace", KeyinTree:="BridgeTripleBrace.keyins")>
